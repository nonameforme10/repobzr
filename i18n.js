...
(function () {
    ...
    var dict = {
        ...
        en: {
            ...
            'activity.categoryCreated': 'Category created',
            'activity.categoryDeleted': 'Category deleted',
            'activity.categoryUpdated': 'Category updated',
            'activity.posSaleNote':     'POS sale ({qty}x @ {price})',
            'activity.posOptomNote':    'POS multi-item sale ({items} items, {units} units, total: {total}{discount})',
            'activity.undoSale':        'Undo sale: {details}',
            'activity.undo':            'Undo: {details}',
            'fx.fromCbu':               'From cbu.uz',
            'fx.usd':                   'USD — US Dollar',
            'fx.eur':                   'EUR — Euro',
            'fx.uzs':                   'UZS — Uzbekistani Som',
            ...
            'pos.undoSale':       'Undo Sale',
            'pos.confirmUndoSale':'Are you sure you want to undo this sale? Product stock will be returned to inventory.',
            'pos.saveChanges':    'Save Changes',
            'pos.saleUpdated':    'Sale updated successfully',
            'pos.saleUndone':     'Sale undone and stock restored',
            'pos.deleteSale':     'Delete Sale',
            'pos.confirmDeleteSaleTitle': 'Delete Sale',
            'pos.confirmDeleteSaleMsg': 'Are you sure you want to delete this sale? Product stock will be returned to inventory.',
            'pos.yesDelete':      'Yes, delete',
            'pos.noCancel':       'No, cancel',
            'pos.saleDeleted':    'Sale deleted and stock restored',
            'pos.addItemToSale':  '+ Add Item',
            'pos.removeItem':     'Remove',
            'pos.unitPrice':      'Unit Price',
            'pos.quantity':       'Quantity',
            'pos.lineSubtotal':   'Line Total',
            'pos.searchProductPlaceholder': 'Search product to add...',
            'pos.saleDiscount':   'Discount (soʻm)',
            'pos.saleNotes':      'Notes / Reason',
            'pos.qtyMustBePositive': 'Quantity must be at least 1',
            'pos.priceMustBePositive': 'Price must be greater than 0',
        ...
        ru: {
            ...
            'activity.productCreated':  'Товар создан',
            'activity.productDeleted':  'Товар удален',
            'activity.productUpdated':  'Товар обновлен',
            'activity.categoryCreated': 'Категория создана',
            'activity.categoryDeleted': 'Категория удалена',
            'activity.categoryUpdated': 'Категория обновлена',
            'activity.posSaleNote':     'POS продажа ({qty} шт. @ {price})',
            'activity.posOptomNote':    'POS оптовая продажа ({items} поз., {units} шт., итог: {total}{discount})',
            'activity.undoSale':        'Отмена продажи: {details}',
            'activity.undo':            'Отмена: {details}',
            'fx.fromCbu':               'Источник cbu.uz',
            'fx.usd':                   'USD — Доллар США',
            'fx.eur':                   'EUR — Евро',
            'fx.uzs':                   'UZS — Узбекский сум',
            ...
            'pos.editSale':       'Редактировать продажу',
            'pos.undoSale':       'Отменить продажу',
            'pos.confirmUndoSale':'Вы уверены, что хотите отменить эту продажу? Товар будет возвращен на склад.',
            'pos.saveChanges':    'Сохранить изменения',
            'pos.saleUpdated':    'Продажа успешно обновлена',
            'pos.saleUndone':     'Продажа отменена, остатки возвращены',
            'pos.deleteSale':     'Удалить продажу',
            'pos.confirmDeleteSaleTitle': 'Удаление продажи',
            'pos.confirmDeleteSaleMsg': 'Вы действительно хотите удалить эту продажу? Товар будет возвращен на склад.',
            'pos.yesDelete':      'Да, удалить',
            'pos.noCancel':       'Нет, отмена',
            'pos.saleDeleted':    'Продажа удалена, остатки возвращены',
            'pos.addItemToSale':  '+ Добавить товар',
            'pos.removeItem':     'Удалить',
            'pos.unitPrice':      'Цена за шт.',
            'pos.quantity':       'Количество',
            'pos.lineSubtotal':   'Сумма',
            'pos.searchProductPlaceholder': 'Поиск товара для добавления...',
            'pos.saleDiscount':   'Скидка (сум)',
            'pos.saleNotes':      'Примечание / Причина',
            'pos.qtyMustBePositive': 'Количество должно быть не менее 1',
            'pos.priceMustBePositive': 'Цена должна быть больше 0',
        ...
        uz: {
            ...
            'activity.productCreated':  'Mahsulot yaratildi',
            'activity.productDeleted':  'Mahsulot oʻchirildi',
            'activity.productUpdated':  'Mahsulot yangilandi',
            'activity.categoryCreated': 'Kategoriya yaratildi',
            'activity.categoryDeleted': 'Kategoriya oʻchirildi',
            'activity.categoryUpdated': 'Kategoriya yangilandi',
            'activity.posSaleNote':     'POS savdosi ({qty} dona @ {price})',
            'activity.posOptomNote':    'POS optom savdo ({items} xil tovar, {units} dona, jami: {total}{discount})',
            'activity.undoSale':        'Savdoni bekor qilish: {details}',
            'activity.undo':            'Bekor qilish: {details}',
            'fx.fromCbu':               'cbu.uz dan',
            'fx.usd':                   'USD — AQSH dollari',
            'fx.eur':                   'EUR — Yevro',
            'fx.uzs':                   'UZS — Oʻzbekiston soʻmi',
            ...
            'pos.editSale':       'Savdoni tahrirlash',
            'pos.undoSale':       'Savdoni bekor qilish',
            'pos.confirmUndoSale':'Ushbu savdoni bekor qilmoqchimisiz? Mahsulotlar qoldigʻi qaytariladi.',
            'pos.saveChanges':    'Oʻzgarishlarni saqlash',
            'pos.saleUpdated':    'Savdo muvaffaqiyatli yangilandi',
            'pos.saleUndone':     'Savdo bekor qilindi va qoldiqlar qaytarildi',
            'pos.deleteSale':     'Oʻchirish',
            'pos.confirmDeleteSaleTitle': 'Savdoni oʻchirish',
            'pos.confirmDeleteSaleMsg': 'Haqiqatan ham ushbu savdoni oʻchirmoqchimisiz? Mahsulotlar qoldigʻi omborga qaytariladi.',
            'pos.yesDelete':      'Ha, oʻchirish',
            'pos.noCancel':       'Yoʻq, bekor qilish',
            'pos.saleDeleted':    'Savdo oʻchirildi va qoldiqlar qaytarildi',
            'pos.addItemToSale':  '+ Mahsulot qoʻshish',
            'pos.removeItem':     'Oʻchirish',
            'pos.unitPrice':      'Dona narxi',
            'pos.quantity':       'Miqdori',
            'pos.lineSubtotal':   'Jami',
            'pos.searchProductPlaceholder': 'Qoʻshish uchun mahsulot qidiring...',
            'pos.saleDiscount':   'Chegirma (soʻm)',
            'pos.saleNotes':      'Izoh / Sabab',
            'pos.qtyMustBePositive': 'Miqdor kamida 1 boʻlishi kerak',
            'pos.priceMustBePositive': 'Narx 0 dan katta boʻlishi kerak',
